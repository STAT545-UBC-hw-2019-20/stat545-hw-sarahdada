...
Task 3-Look at the spread with in continents-  of the interquartile range-geom boxplot or geom violin.
```{r}
...
GapminderPercap %>% mutate(mean=mean(gdpPercap))
  
GapminderPercap %>% 
dplyr::filter(n > quantile(n, 0.25), 
                n < quantile(n, 0.75))

GapminderPercap %>% spread(continent,n)
